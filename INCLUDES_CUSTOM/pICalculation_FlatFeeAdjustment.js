function pICalculation_FlatFeeAdjustment() {
...
if (CloseDate == null && DaysLate > 0 && DaysLate < 31 && finalOldBusLicFee < finalNewBusLicFee) {
...
if (CloseDate == null && DaysLate >= 30 && finalOldBusLicFee < finalNewBusLicFee) {
